...
## ✨ Key Features
* **Edge AI (100% Offline):** Uses a pre-trained Vision Transformer (ViT) model. No cloud data or WiFi required.
* **Portable Deployment:** Runs directly from a USB drive or local folder with zero installation.
* **Batch Processing:** Analyze entire folders of excavation photos in seconds.
* **Professional Reporting:** Automatically generates `.xlsx` (Excel) reports with labels and confidence scores.

## 🛠 Technical Specifications
- **Core Engine:** Python 3.12 (Embedded)
- **AI Framework:** PyTorch & HuggingFace Transformers
- **GUI:** Custom Tkinter Interface
...
1.  Download the `ArchaeologyApp_Installer.exe` from the [Releases](https://github.com/YourUsername/Repository/releases) tab.
...
---
**Developed by Umar S. Bakhodirjonov** *Innovation Project - FLL Submerged 2026*
